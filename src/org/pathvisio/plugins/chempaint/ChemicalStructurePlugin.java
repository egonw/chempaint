...
public class ChemicalStructurePlugin implements Plugin
{
	ChemicalStructurePane pane;
	
	public void init(PvDesktop standaloneEngine) 
	{
		pane = new ChemicalStructurePane(standaloneEngine.getSwingEngine());
		JTabbedPane sidebarTabbedPane = standaloneEngine.getSideBarTabbedPane();
		sidebarTabbedPane.add(ChemicalStructurePane.TITLE, pane);
